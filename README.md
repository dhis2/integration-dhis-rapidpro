...
| `reminder.data.set.ids`               | Cron expression specifying when queued reports are delivered to DHIS2.                                                                                               |                                            | `0 0 0 * * ?`                                      |
| `report.delivery.schedule.expression` | By which field organisation units are identified.                                                                                                                    | `ID`                                       | `CODE`                                             |
