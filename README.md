...
| `webhook.security.token`              | Webhook HTTP authentication token. Only applicable if `webhook.security.auth` is set to `token`. A secure token should be at least 12 characters long with a mix of lower and upper case letters, numbers, and symbols.                                                                                 |                                                                                | `ea0ebc18b0bb41f399928a93445a6f8a`                                                                                                   |
